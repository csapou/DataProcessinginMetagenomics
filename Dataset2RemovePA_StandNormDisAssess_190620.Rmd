...
#To create PCoA/PCA
TestCol<-c("AFR" = "#377EB8", "AAM" = "#E41A1C") 
...
#using the "poscounts". 
design <- formula(paste("~ ", "nationality"))
...
#Multi dimensional scaling with capscale 
    ...
    PCoAList[[ pltName ]]<-ggplot(Metadata2) + 
      ...
      geom_jitter(aes(MDS1, MDS2, col=nationality, shape=bmi_group), width=0.00, height=0.00, 
