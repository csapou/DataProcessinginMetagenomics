...
#install.packages(c("vegan", "rlang", "Rcpp", "tidyselect", "dplyr", "knitr", "ggplot2", "pheatmap", "zCompositions", "compositions", "reshape", "tidyr", "gridExtra", "cowplot", "stringi", "ggthemes", "scales", "RColorBrewer"))
...
PCoAList[[ pltName ]]<-ggplot(MetadataProC2) + 
  ...
  labs(colour="Preprocessing", shape="ßdiversity", x = eig_1, y = eig_2) + 
  theme_bw() + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.title=element_text(size=12), legend.position="bottom") #+
